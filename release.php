...
include './assets/controllers/release/release_controller.php';
...
<body>
    ...
    <div class="container my-4">
        ...
        <div id="scanSection" class="scan-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="releaseForm" action="release.php" method="POST">
                        ...
                        <div class="mb-3">
                            <label for="codeProduct" class="form-label">
                                ...
                                <span class="text-muted small ms-2">Scan multiple products continuously</span>
                            </label>
                            <div class="input-group">
                                <input type="text" class="form-control form-control-lg" id="codeProduct" name="codeProduct" placeholder="Scan or enter product code" required>
    ...
    <script src="./assets/scripts/release.js"></script>
</body>
